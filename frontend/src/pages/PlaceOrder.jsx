...
function PlaceOrder() {
    ...
    const { navigate, backendUrl, token, cartItems, setCartItems, getCartAmount, deliver_fee, products } = useContext(ShopContext);
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            for (const itemId in cartItems) {
                ...
                // Iterate through each size for the item
                for (const size in itemSizes) {
                    const quantity = itemSizes[size];
                    
                    // Only add to order if quantity is greater than 0
                    if (quantity > 0) {
            ...
            <div className='mt-8'>
                ...
                <div className='mt-12'>
                    ...
                    <div className='w-full text-end mt-8'>
                        <button type='submit' className='bg-black text-white px-6 py-3 text-sm rounded transition duration-300 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50'>
                            PLACE ORDER
                        </button>
                    </div>
                </div>
